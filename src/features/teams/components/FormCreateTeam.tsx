...
const FormCreateTeamSchema = z.object({
    name: z
        .string({
...
type FormCreateAccountType = z.infer<typeof FormCreateTeamSchema>;
// type CreateTeamFormTypeOutput = z.infer<typeof CreateTeamFormSchemaOutput>;

const formCreateTeamDefaultValues: FormCreateAccountType = {
    name: '',
    sport: '',
    type: '',
    max_members: '',
...
const FormCreateTeam = () => {
    ...
    const {
        ...
        resolver: zodResolver(FormCreateTeamSchema),
        defaultValues: formCreateTeamDefaultValues
    });
    ...
    return (
        <ScrollView
            ...
            <TouchableOpacity style={styles.formButton} onPress={handleSubmit(onSubmitPress)}>
                <Text style={styles.formButtonText}>Create Team</Text>
            </TouchableOpacity>
        </ScrollView>
    );
};
